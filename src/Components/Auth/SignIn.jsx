    ...
    <div className="flex justify-center items-center h-screen bg-cover bg-no-repeat bg-center" style={{backgroundImage: `url(${AuthBg})`}}>
      ...
      <div className="text-center border-neutral-500 border-2 rounded-xl bg-gray-100 bg-opacity-90 shadow-[0px_3px_6px_6px_rgba(0,_0,_0,_0.16)] px-4 py-8 w-1/3 mtiny:w-4/5 my-5">
        ...
        <div>
          ...
          <div className="inline-block w-1/6 h-0.5 border-b border-black" />
          <button className="block bg-neutral-200 hover:bg-neutral-300 border-neutral-400 transition-all border-2 w-3/4 mx-auto my-4 py-2 rounded">
            <img className="w-6 inline-block" src="https://img.icons8.com/color/48/000000/google-logo.png" alt="google" />
            <span className="text-black font-semibold ml-4">Sign in with Google</span>
          </button>
        </div>
        <form className="text-left my-5 text-xl" onSubmit={handleSubmit}>
