            ...
            
            {
                filters.map((filter, index) => {
                    return (
                        <div
                            key = {index}
                            className={`${filterclass === filter.class ? 'rounded-md border-blue-500 border-2 text-blue-500 text-sm' : ''} cursor-pointer overflow-hidden hover:border-blue-500 hover:border-2 hover:rounded-md hover:text-sm`}
                            onClick={() => {
